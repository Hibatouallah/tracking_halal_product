    ...
    render() {
      ...
      const {
        ...
        const options = [
          ...
          { value: "organismedecontrole" , label: 'organisme de contrôle'},
          ...
          { value: 'societe_de_netoyage', label: 'Sociètè de nétoyage' },
          { value: 'eleveur', label: 'Eleveur' },
          { value: 'atelier_de_decoupe', label: 'Atelier de découpe' },
